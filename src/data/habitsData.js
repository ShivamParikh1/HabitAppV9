export const habitsData = {
  ...
  'social-media': {
    ...
    type: 'break',
    image: 'https://images.unsplash.com/photo-1611262588024-d12430b98920?w=80&h=80&fit=crop&crop=center',
    description: 'Excessive social media use can lead to comparison, anxiety, and time waste. Reducing usage can improve mental health and free up time for meaningful activities.',
    methods: [
      {
        title: 'Time Limits',
        description: 'Set daily time limits for social media apps using built-in screen time controls.'
      },
      {
        title: 'Unfollow Triggers',
        description: 'Unfollow accounts that make you feel bad about yourself or waste your time.'
      },
      {
        title: 'Replace with Real Connection',
        description: 'When you feel the urge to scroll, call or text a friend instead.'
      }
    ],
    ...
    methods: [
      {
        ...
        description: 'Don\'t keep junk food in your house. If it\'s not there, you can\'t eat it.'
      },
      {
        title: 'Healthy Substitutes',
        description: 'Replace chips with nuts, candy with fruit, or soda with sparkling water.'
      },
      {
        title: 'Plan Your Meals',
        description: 'Meal prep healthy options so you\'re not tempted by convenience foods.'
      }
    ],
